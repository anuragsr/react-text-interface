            ...
            {this.props.showProgress && (
              <div className="modal-content progress">
                <div className="bar-outer">
                  <div
                    className="bar-inner"
                    style={{ width: `${this.props.upProgress}%` }}
                  ></div>
                </div>
              </div>
            )}
              ...
              <div className="modal-content">
                <div ref={this.dropInput} className="dropzone">
                  ...
                  <input
                    ...
                    ref={this.fileInput}
                    onChange={() =>
                      this.prepareForUpload(this.fileInput.current.files)
                    }
                  />
                  <div>
                    Drop any audio file or{" "}
                ...
                <div className="ctn-up-action">
                  <div
                    className={`ctn-up-msg ${this.state.showErr ? "err" : ""}`}
                  >
